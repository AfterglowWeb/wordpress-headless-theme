...
export default function ConfirmDialog() {
	...
	const getDefaultTitle = () => {
		switch ( type ) {
			case DIALOG_TYPES.SUCCESS:
				return __( 'Success', 'blank' );
			case DIALOG_TYPES.ERROR:
				return __( 'Error', 'blank' );
			case DIALOG_TYPES.INFO:
				return __( 'Information', 'blank' );
			case DIALOG_TYPES.LOADING:
				return __( 'Please wait...', 'blank' );
			default:
				return __( 'Confirm', 'blank' );
		}
	};
