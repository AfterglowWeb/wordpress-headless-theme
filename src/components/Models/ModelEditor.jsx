          ...
          <Paper key={field.original_key} sx={{ p: 2, mb: 2 }}>
            ...
            <Box display="flex" gap={2}>
              <TextField
                ...
                value={field.key}
                onChange={e =>
                  updateField(field.original_key, 'key', e.target.value)
                }
                fullWidth
              />
              ...
              <TextField
                ...
                onChange={e =>
                  updateField(field.original_key, 'sanitize_callback', e.target.value)
                }
                fullWidth
              />
              ...
              <TextField
                ...
                onChange={e =>
                  updateField(field.original_key, 'parse_callback', e.target.value)
                }
                fullWidth
              />
            </Box>
            ...
            {sample?.[field.original_key] !== undefined && (
              ...
              >
                Sample: {JSON.stringify(sample[field.original_key]).slice(0, 80)}…
              </Typography>
            )}
          </Paper>
        ))}
