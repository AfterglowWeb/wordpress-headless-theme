	...
	<Stack spacing={3}>
		...
		<FormControl>
			<FormControlLabel
				...
				label={__('Enable Exposed Posts Types Restict', 'blank')}

			/>
			<FormHelperText>{__('This will enable post type exposition settings accross WordPress REST API and Blank REST API.', 'blank')}</FormHelperText>
		</FormControl>
		...
		<Box sx={{ minWidth: 120 }}>
			...
			helperText={'Exposed post types in the REST API. If empty, the default show_in_rest post_type options are applied'}
			options={postTypes} 
			onChange={setField} />}
		</Box>
		...
		<TextField
			...
			min="0"
			max="1000"
			helperText={__('This applies to the Blank REST attachments endpoint.', 'blank')}
