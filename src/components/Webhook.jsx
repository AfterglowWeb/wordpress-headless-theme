...
export default function Webhook({form, setField}) {
    ...
    const confirmConfig = {
        delete: {
            ...
            content: __('Any applications using this webhook secret will stop working. Continue?', 'blank'),
            action: deleteWebhookSecret,
        },
        regenerate: {
            title: __('Regenerate Webhook Secret', 'blank'),
            content: __('Regenerating the webhook secret will invalidate the current one. Any applications using the old secret will stop working. Continue?', 'blank'),
    ...
    >
        ...
        <DialogContent>
            <DialogContentText>
                {confirmAction && confirmConfig[confirmAction].content}
            </DialogContentText>
        </DialogContent>
        <DialogActions>
