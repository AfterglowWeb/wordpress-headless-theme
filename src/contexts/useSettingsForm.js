...
export default function useSettingsForm( {
	...
	const [ form, setForm ] = useState( {
		blank_use_rest_models_enabled: false,
		...
		blank_embed_author_enabled: false,
		blank_with_acf_enabled: false,
		blank_sync_acf_fields_to_json_enabled: false,
	...
	useEffect( () => {
		...
		setForm( {
			blank_use_rest_models_enabled: Boolean(
				adminOptions.blank_use_rest_models_enabled
			),
			blank_embed_featured_attachment_enabled: Boolean(
				adminOptions.blank_embed_featured_attachment_enabled
			),
			blank_embed_author_enabled: Boolean(
				adminOptions.blank_embed_author_enabled
			),
			...
			blank_sync_acf_fields_to_json_enabled:Boolean(
				adminOptions.blank_sync_acf_fields_to_json_enabled
			), 
	...
	const mapFormToAdminOptions = useCallback(
		( formData ) => ( {
			...
			blank_embed_terms_enabled: 
				formData.blank_embed_terms_enabled,
			blank_embed_author_enabled: 
				formData.blank_embed_author_enabled,
			blank_with_acf_enabled: 
				formData.blank_with_acf_enabled,
			blank_sync_acf_fields_to_json_enabled: 
				formData.blank_sync_acf_fields_to_json_enabled,
