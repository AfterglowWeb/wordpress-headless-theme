<?php namespace cmk\blank\Rest\Controllers;
...
class AttachmentController {
	...
	public function __construct() {
		 ...
		 */
		add_filter(
			'blank_rest_relative_attachment_url',
		...
		add_filter(
			'blank_embed_featured_attachment',
	...
	public static function attachments_per_post_flat( WP_Post $post ): array {
		...
		return (array) apply_filters( 'blank_rest_attachments_per_post', array_filter( $attachments ) );
	}
